...
namespace ProdutosGeek
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\Aluno\\Desktop\\ProdutosGeek23\\ProdutosGeek\\ProdutosGeek\\BdGeek.mdf;Integrated Security=True");
        public FrmVenda()
        {
            InitializeComponent();
        }
        ...
        private void btnLocalizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    lvenda.Parameters.AddWithValue("@Id", SqlDbType.Int).Value = Convert.ToInt32(txtId.Text);
        ...
        private void btnAtualizarPedido_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandType = CommandType.Text;
            cmd.Parameters.Add("@Id", SqlDbType.Int).Value = Convert.ToInt32(txtId.Text.Trim());
        ...
        private void btnFinalizarVenda_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            SqlCommand deletarpedido = new SqlCommand("DELETE FROM ItensVendido WHERE id_venda = @Id", con);
            deletarpedido.CommandType = CommandType.Text;
            deletarpedido.Parameters.AddWithValue("@Id", SqlDbType.Int).Value = Convert.ToInt32(txtId.Text.Trim());
            deletarpedido.ExecuteNonQuery();
            foreach (DataGridViewRow dr in dgvPedido.Rows)
            ...
            con.Close();
            MessageBox.Show("Pedido vendido com sucesso!", "Venda do pedido", MessageBoxButtons.OK, MessageBoxIcon.Information);
            dgvPedido.Columns.Clear();
            dgvPedido.Rows.Clear();
            txtId.Text = "";
            txtTotal.Text = "";
